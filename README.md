...
![[스크린샷 2026-03-31 오후 12.10.15.png]]
![[스크린샷 2026-03-31 오후 12.11.04.png]]
...
![[스크린샷 2026-03-31 오후 2.20.28.png]]
-> $ docker run -it ubuntu bash 
![[스크린샷 2026-03-31 오후 3.33.44.png]]
진입 성공 !
#### 옵션 A: Dockerfile 만들기
```dockerfile
FROM nginx:alpine
...
```
![[스크린샷 2026-03-31 오후 4.14.53.png]]
...
```
![[스크린샷 2026-03-31 오후 3.41.11.png]]
...
```
![[스크린샷 2026-03-31 오후 3.47.13.png]]
![[스크린샷 2026-03-31 오후 3.48.01.png]]
...
![[스크린샷 2026-03-31 오후 4.26.08.png]]
![[스크린샷 2026-03-31 오후 4.38.04.png]]
...
![[스크린샷 2026-03-31 오후 4.51.14.png]]
...
![[스크린샷 2026-03-31 오후 5.04.49.png]]
-> 실행중인 컨테이너 상세 정보 출력
...
* **현재 위치 확인**
	$ pwd
	![[스크린샷 2026-03-30 오후 5.31.33.png]]

* **목록 확인 (숨김 파일 포함)**
	$ ls -l
	$ ls -al
	![[스크린샷 2026-03-30 오후 5.32.15.png]]

* **이동**
	$ cd "파일 경로"
	$ cd .. -> 상위 경로
	$ cd ~ -> home
	![[스크린샷 2026-03-30 오후 6.11.47.png]]

* **생성**
	$ mkdir "폴더 이름"
	$ mkdir -p "상위경로"/"하위경로" -> 둘다 생성
	$ echo "content" > "파일 명"
	![[스크린샷 2026-03-30 오후 5.42.33.png]]

* **복사**
	$ cp "res" "dest"
	$ cp -r "res" "dest" -> 폴더 통채로 복사
	![[스크린샷 2026-03-30 오후 5.45.47.png]]

* **이동/ 이름변경**
	$ mv "res file" "dest folder" -> 이동
	$ mv "res file" "dest file" -> 이름 변경
	![[스크린샷 2026-03-30 오후 5.54.37.png]]

* **삭제**
	$ rm "파일 명"
	![[스크린샷 2026-03-30 오후 5.55.00.png]]
	$ rm -r "폴더 명"
	![[스크린샷 2026-03-30 오후 5.52.00.png]]
	$ rm -rf "파일 명" -> 강제 삭제

* **파일 내용 확인**
	$ cat "파일 명"
	![[스크린샷 2026-03-30 오후 5.57.38.png]]

* **빈 파일 생성**
	$ touch "파일 명"
	![[스크린샷 2026-03-30 오후 5.59.21.png]]

###  권한 실습 및 증거 기록
	
![[스크린샷 2026-03-30 오후 6.22.07.png]]
	![[스크린샷 2026-03-30 오후 6.28.18.png]]
	-> x 가 없어서 cd 실행 불가
	![[스크린샷 2026-03-30 오후 6.35.26.png]]
	-> w변경으로 생성 권한 제어
	![[스크린샷 2026-03-30 오후 6.37.07.png]]
	-> 파일 읽기 권한 변경
